        ...
        <div className="container mx-auto px-4 py-32 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <motion.img
                ...
                animate={{
                  y: [0, -12, 0],
                  filter: [
                    'drop-shadow(0 0 15px rgba(30,144,255,0.5))',
            ...
            <motion.div
              ...
              animate="visible"
            >
              <motion.p variants={fadeUp} className="font-script text-gold-400 text-3xl mb-2">
                Bienvenue chez
              </motion.p>
              <motion.h1 variants={fadeUp} className="font-display text-6xl md:text-8xl font-bold text-white mb-3 leading-none">
              ...
              <motion.div variants={fadeUp} className="flex items-center justify-center gap-3 mb-8">
                ...
                <span className="text-gold-400 font-semibold tracking-[0.4em] text-sm">✦ HIJAB FASHION ✦</span>
                <div className="divider-gold w-16" />
              </motion.div>
              <motion.p variants={fadeUp} className="text-white/70 text-xl mb-12 leading-relaxed max-w-lg mx-auto">
                Des hijabs d'exception pour la femme élégante moderne.
              ...
              <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link to="/boutique?featured=true"
                      className="btn-outline-blue inline-flex items-center gap-2 text-lg px-8 py-4">
                  Pièces phares ✨
                </Link>
              </motion.div>
            </motion.div>
