...
const TESTIMONIALS = [
  {
    name: "Fatou D.",
    city: "Dakar",
    text: "Qualité exceptionnelle ! Le hijab est encore plus beau en vrai. Je recommande vivement.",
    stars: 5,
  },
  {
    name: "Mariama B.",
    city: "Abidjan",
    text: "Livraison super rapide, emballage cadeau magnifique. Ma sœur a adoré son cadeau !",
    stars: 5,
  },
  {
    name: "Aminata S.",
    city: "Conakry",
    text: "Service client au top, je suis conquise par ChezAntaBada. Ma boutique préférée !",
    stars: 5,
  },
  {
    name: "Aïssatou K.",
    city: "Bamako",
    text: "Des couleurs sublimes, la soie est d'une douceur incroyable. Commande déjà passée !",
    stars: 5,
  },
];
...
const VALUES = [
  {
    ...
    desc: "Matières naturelles certifiées",
    color: "text-gold-400",
  },
  {
    icon: FiTruck,
    label: "Livraison rapide",
    desc: "Toute le Sénégal en 48h",
    color: "text-blue-400",
  },
  {
    icon: FiHeart,
    label: "Fait avec amour",
    desc: "Collections artisanales uniques",
    color: "text-gold-400",
  },
  {
    icon: FiShield,
    label: "Paiement sécurisé",
    desc: "Stripe SSL 256-bit",
    color: "text-blue-400",
  },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Découvrez notre collection exclusive de hijabs élégants. Qualité premium, livraison rapide partout en Afrique."
        />
      </Helmet>
      ...
      <section
        ref={heroRef}
        className="relative min-h-screen bg-night overflow-hidden flex items-center"
      >
        {/* Background parallax */}
          ...
          <div className="w-full max-w-2xl mx-auto text-center">
            <motion.div variants={stagger} initial="hidden" animate="visible">
              ...
              >
                ...
                <br />
                Qualité premium · Livraison rapide au Sénégal.
              </motion.p>
              ...
              >
                ...
                <Link
                  to="/boutique?featured=true"
                  className="btn-outline-blue inline-flex items-center gap-2 text-base px-10 py-4"
                >
                  Pièces phares ✨
                </Link>
              </motion.div>
          ...
          >
            {STATS.map((s, i) => (
              <motion.div
                ...
                className="relative"
              >
                <p className="font-display text-4xl font-bold gold-text mb-1">
                  {s.value}
                </p>
      ...
      <section className="py-24 bg-dark">
        <div className="container mx-auto px-4">
          ...
          >
            <motion.p
              variants={fadeUp}
              className="font-script text-gold-400 text-2xl mb-3"
            >
              Notre sélection
            </motion.p>
            ...
            <motion.div
              variants={fadeUp}
              className="divider-gold w-24 mx-auto"
            />
          </motion.div>
      ...
      <section className="py-24 bg-night">
        <div className="container mx-auto px-4">
          ...
          >
            <motion.p
              variants={fadeUp}
              className="font-script text-blue-400 text-2xl mb-3"
            >
              Explorez
            </motion.p>
            <motion.h2 variants={fadeUp} className="section-title mb-4">
            ...
            {(collections || []).map((col, i) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  ...
                  {col.description && (
                    <p className="text-gold-300 text-sm mb-4">{col.description}</p>
                  )}
                  <motion.div
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="font-script text-gold-400 text-xl mb-2">
                Offre spéciale
              </p>
              ...
              <p className="text-muted text-lg">
                Pour toute commande supérieure à 30 000 FCFA
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 40 }}
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-muted mb-6">
              ...
              <span className="text-gold-400 font-semibold">@chezantabada</span>{" "}
              sur Instagram
            </motion.p>
            <motion.a
              variants={fadeUp}
      ...
      <section className="py-28 bg-night relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            <motion.p
              variants={fadeUp}
              className="font-script text-gold-400 text-3xl mb-3"
            >
              Prête ?
            </motion.p>
            <motion.h2
            ...
            >
              Sublimez
              <br />
              votre <span className="gold-text">style</span>
            </motion.h2>
            <motion.p
              variants={fadeUp}
              className="text-white/60 mb-10 text-lg max-w-md mx-auto"
            >
              Rejoignez des milliers de femmes élégantes qui font confiance à
              ChezAntaBada.
            </motion.p>
            <motion.div
              variants={fadeUp}
